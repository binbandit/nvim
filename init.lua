...
require('lazy').setup({
    ...
    -- NOTE: Gitsigns configuration has been moved to lua/bandit/plugins/gitsigns.lua
    ...
    { -- Highlight, edit, and navigate code
        ...
        opts = {
            ensure_installed = { 'bash', 'c', 'diff', 'html', 'lua', 'luadoc', 'markdown', 'markdown_inline', 'query', 'vim', 'vimdoc', 'rust', 'typescript', 'tsx', 'javascript' },
    ...
    --
    -- NOTE: These plugins have been moved to lua/bandit/plugins/ and are loaded automatically
